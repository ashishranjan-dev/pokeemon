import 'package:pokeemon/core/extensions/string.dart';
import 'package:pokeemon/data/source/github/models/item.dart';

import 'package:pokeemon/data/source/github/models/pokemon.dart';
import 'package:pokeemon/data/source/local/models/item.dart';

import 'package:pokeemon/data/source/local/models/pokemon.dart';
import 'package:pokeemon/data/source/local/models/pokemon_gender.dart';
import 'package:pokeemon/data/source/local/models/pokemon_stats.dart';
